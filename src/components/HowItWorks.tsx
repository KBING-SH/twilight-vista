...
const steps = [
  {
    step: "01",
    title: "Upload Photo",
    desc: "Drag and drop or click to upload any photo. Supports PNG / JPG / WEBP, up to 20 MB.",
    color: "from-primary to-theme1",
  },
  {
    step: "02",
    title: "Describe & Generate",
    desc: "Enter a prompt to describe the edits you want, choose a model, and click generate. Rita AI delivers results in seconds.",
    color: "from-theme1 to-emerald-400",
  },
  {
    step: "03",
    title: "Download & Share",
    desc: "Instantly download HD watermark-free images, or share to social platforms with one click.",
  ...
  return (
    <section className="py-10 md:py-24 bg-card-alt">
      <div className="container px-4 md:px-8">
        <h2 className="text-xl md:text-3xl font-bold text-title text-center mb-2 md:mb-3">How to Edit an Image with AI in 3 Steps</h2>
        <p className="text-sm md:text-base text-body-desc text-center mb-6 md:mb-12">No design skills needed — upload your photo, describe the edit, and download the result instantly</p>
